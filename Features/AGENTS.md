...
- AH Scheduler owns the unified AH Buy/Sell bindable action. It must only start AH actions through AH Sniper/AH Selling status-returning APIs, count only successful normal buy/bait calls toward the sell cadence, prioritize active AH Sniper bulk follow-up before selling, and avoid starting a new AH action while buy, bait, sell scan, or sell post work is pending.
